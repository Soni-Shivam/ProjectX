...
class Swap(models.Model):
    ...
    status
    '''
    user_initiater = models.ForeignKey(
    settings.AUTH_USER_MODEL,
    on_delete=models.CASCADE,
    related_name='sent_swaps',  # 👈 unique reverse name
    ...
    user_reciever = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
        related_name='received_swaps',  # 👈 unique reverse name
        verbose_name="User who receives the swap request."
    )

    user_initiater_skill = models.CharField(
        max_length=settings.SKILL_MAX_LENGTH,
        verbose_name="Skill offered by the initiater/requester."
    )

    user_reciever_skill = models.CharField(
        max_length=settings.SKILL_MAX_LENGTH,
        verbose_name="Skill offered by the reciever.",
    )
